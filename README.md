...
<li>Check for the pin connection in arduino code to connect with gsm module</li>
  <li>To enable sms, connect arduino to computer(host) and on gsm module with pin connection with arduino<b>[otherwise <u>ERROR COM PORT</u>will be shown]</b></li>
</ul><h2>Usage</h2>
